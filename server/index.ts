...
import {
  ...
  projectLaunchConfigGetHandler,
  projectLaunchConfigSaveHandler,
  projectsListHandler,
  projectsOpenHandler,
...
try {
  ...
  routes: guardApiRoutes({
    ...
    "/api/projects/launch-config": {
      GET: projectLaunchConfigGetHandler,
      PUT: projectLaunchConfigSaveHandler,
    },
