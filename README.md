...
The app carries its own server — there is nothing else to install. macOS builds
are signed and notarized; the Windows installer isn't signed yet, so SmartScreen
